...
The SDK is ESM and consumed directly from TypeScript source. Run the script with [`tsx`](https://github.com/privatenumber/tsx), for example `npx tsx your-script.ts`; there is no SDK build to keep in sync.
